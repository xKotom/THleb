    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(blank=True, max_length=100, verbose_name='Имя или псевдоним')),
                ('card_number', models.CharField(max_length=50, unique=True, verbose_name='Номер клубной карты')),
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='Дата рождения')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='photos/', verbose_name='Фото')),
                ('bio', models.TextField(blank=True, verbose_name='О себе')),
                ('bonus_points', models.IntegerField(default=0, verbose_name='Бонусы')),
